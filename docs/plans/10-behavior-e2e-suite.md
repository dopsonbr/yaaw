...
- Screenshots are captured for launch, project creation, Files mode, Browser mode, `nvim` mode, Git mode, global terminal expanded, and panel resize/collapse states.
