...
/// Resolves and launches external editors/tools for the selected file or
/// directory. Pure app-layer glue around `NSWorkspace`; the stores hand it an
/// `ExternalOpenTarget` and an `ExternalOpenToolID`.
@MainActor
